...
The Salão Arrazus will then launch a Tomcat instance with the given war deployed to it. This takes advantage of Tomcat's embedded APIs and is similar to an option that Jetty offers: [Jetty Runner](http://blogs.webtide.com/janb/entry/jetty_runner).
...
And then run your app using the java command:
    ...
    :::term
    $ java -jar target/salao-arrazus.jar target/*.war
